  ...
  return (
    ...
    >
      <div className="min-h-screen bg-white flex flex-col items-center justify-between text-center px-4 sm:px-6 lg:px-8 select-none">
        ...
        {/* Hero Section */}
        <main className="flex flex-col md:flex-row items-center justify-center gap-12 px-4 sm:px-8 md:px-10 py-12 sm:py-14 md:py-16 w-full max-w-6xl mx-auto">
          {/* Text */}
          ...
          <div className="grid grid-cols-1 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <SpotlightCard
                ...
                className={`custom-spotlight-card ${item.gradient} rounded-xl py-4 sm:py-8 md:py-10 mx-7 flex flex-col md:flex-row items-center md:text-left shadow-xl hover:scale-[1.01] hover:shadow-2xl`}
              ...
              >
                ...
                {/* Text content */}
                <div className="flex-1 flex flex-col justify-center z-100">
