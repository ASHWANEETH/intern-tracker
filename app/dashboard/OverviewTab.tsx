...
export default function OverviewTab({ jobs, setActiveTab }: Props) {
  ...
  return (
    <div className="w-full px-1 sm:px-4 md:px-4 space-y-3 sm:space-y-4 mt-0 sm:mt-0">
      {jobs.length === 0 ? (
        <SpotlightCard className="text-center px-3 py-6 sm:p-6 flex flex-col items-center gap-10 bg-violet-50 dark:bg-violet-900/10 shadow rounded-xl">
        ...
        <AnimatedList
          ...
          className="min-h-[600px]" // Remove max-h-[300px]
          showGradients={false}
